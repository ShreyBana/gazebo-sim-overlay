...
rec {
  ...
  ignition = rec {
    ...
    cmake3 = pkgs.callPackage ./ignition/cmake/3.nix { protobuf = pkgs.protobuf_29; };
    ...
    common5 = pkgs.callPackage ./ignition/common/5.nix { protobuf = pkgs.protobuf_29; };
    ...
    math7 = pkgs.callPackage ./ignition/math/7.nix { protobuf = pkgs.protobuf_29; };
    ...
    gui8 = pkgs.libsForQt5.callPackage ./ignition/gui/8.nix { protobuf = pkgs.protobuf_29; };
    gui9 = pkgs.libsForQt5.callPackage ./ignition/gui/9.nix { };
    gui = gui9;
    sensors6 = pkgs.libsForQt5.callPackage ./ignition/sensors/6.nix { };
    sensors8 = pkgs.libsForQt5.callPackage ./ignition/sensors/8.nix { protobuf = pkgs.protobuf_29; };
    sensors9 = pkgs.libsForQt5.callPackage ./ignition/sensors/9.nix { };
    sensors = sensors9;
    launch7 = pkgs.libsForQt5.callPackage ./ignition/launch/7.nix { protobuf = pkgs.protobuf_29; };
    launch = launch7;
    sim6 = pkgs.libsForQt5.callPackage ./ignition/sim/6.nix { };
    sim8 = pkgs.libsForQt5.callPackage ./ignition/sim/8.nix { protobuf = pkgs.protobuf_29; };
